...
public class MainActivity extends AppCompatActivity {
    ...
    private class GetPrepayIdTask extends AsyncTask<Void, Void, Map<String, String>> {
        ...
        protected void onPostExecute(Map<String, String> result) {
            ...
            if (result == null) {
                Toast.makeText(MainActivity.this, getString(R.string.get_prepayid_fail), Toast.LENGTH_LONG).show();
            } else {
                if (result.get("status").equalsIgnoreCase("0")) // 成功
                {
                    ...
                    if (typetag) {
                        ...
                        PayPlugin.unifiedH5Pay(MainActivity.this, msg);
                    }
                } else {
                    Toast.makeText(MainActivity.this, getString(R.string.get_prepayid_fail), Toast.LENGTH_LONG)
                            .show();
                }
